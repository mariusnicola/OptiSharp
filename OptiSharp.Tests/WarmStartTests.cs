...
public class WarmStartTests
{
    private SearchSpace CreateSimpleSpace() =>
        new SearchSpace(new ParameterRange[] { new FloatRange("x", 0, 10), new IntRange("y", 0, 5) });
    ...
    public void WarmStart_CopiesIntermediateValues()
    {
        ...
        using var study = Optimizer.CreateStudy("test", space, warmStartTrials: new List<Trial> { warmTrial });
    ...
    public void WarmStart_CopiesMultiObjectiveValues()
    {
        ...
        using var study = Optimizer.CreateStudy("test", space, directions, warmStartTrials: new List<Trial> { warmTrial });
    ...
    public void WarmStart_WithRandomSampler()
    {
        ...
        using var study = Optimizer.CreateStudyWithRandomSampler("test", space, warmStartTrials: new List<Trial> { warmTrial });
